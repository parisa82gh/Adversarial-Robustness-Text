...
python roberta.py --train /project/verma/TextAttack_Parisa/data/train_adv_half.csv --valid /project/verma/TextAttack_Parisa/data/valid_emails.csv --test /project/verma/TextAttack_Parisa/data/test_emails.csv
...
textattack attack --model-from-huggingface /project/verma/TextAttack_Parisa/roberta_adv_half/roberta_model --dataset-from-file /project/verma/TextAttack_Parisa/roberta_adv_half/textAttack_dataset.py --recipe deepwordbug --num-examples 518
