...
def main():
    ...
    tokenizer = RobertaTokenizer.from_pretrained("/project/verma/TextAttack_Parisa/roberta/roberta_model")
    ...
    num_labels = 2
    model = RobertaForSequenceClassification.from_pretrained("/project/verma/TextAttack_Parisa/roberta/roberta_model", num_labels=num_labels)
