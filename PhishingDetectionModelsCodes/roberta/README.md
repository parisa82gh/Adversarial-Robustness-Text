...
python roberta.py --train /project/verma/TextAttack_Parisa/data/train_emails.csv --valid /project/verma/TextAttack_Parisa/data/valid_emails.csv --test /project/verma/TextAttack_Parisa/data/test_emails.csv
...
textattack attack --model-from-huggingface /project/verma/TextAttack_Parisa/roberta/roberta_model --dataset-from-file /project/verma/TextAttack_Parisa/roberta/textAttack_dataset.py --recipe bae --num-examples 518
