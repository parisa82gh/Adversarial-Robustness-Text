...
from transformers import TrainingArguments, Trainer, AutoTokenizer, YosoForSequenceClassification
...
def main():
    ...
    model.save_pretrained("yoso_model")
    tokenizer.save_pretrained("yoso_model")
