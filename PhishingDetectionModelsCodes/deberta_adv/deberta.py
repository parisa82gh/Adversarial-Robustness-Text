...
def main():
    ...
    #The above line of code loads the original model tokenizer from huggingface hub
    #The below code loads the tokenizer from a fine-tuned model on IWSPA 2.0 dataset
