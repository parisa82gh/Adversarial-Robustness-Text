...
textattack attack --model-from-huggingface /project/verma/TextAttack_Parisa/deberta_adv/deberta_model --dataset-from-file /project/verma/TextAttack_Parisa/deberta_adv/textAttack_dataset.py --recipe deepwordbug --num-examples 518
