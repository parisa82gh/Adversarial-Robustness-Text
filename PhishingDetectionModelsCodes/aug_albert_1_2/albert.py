...
def main():
    ...
    df_train.to_csv('train_emails_1_2.csv',index=False)
    df_valid.to_csv('valid_emails_1_2.csv',index=False)

    dataset = load_dataset('csv', data_files= {'train':'train_emails_1_2.csv', 'valid':'valid_emails_1_2.csv', 'test':args.test})
    ...
    model.save_pretrained("albert_model_1_2")
    tokenizer.save_pretrained("albert_model_1_2")
