...
from transformers import TrainingArguments, Trainer, SqueezeBertTokenizer, SqueezeBertForSequenceClassification
...
def main():
    ...
    model.save_pretrained("squeezebert_model")
    tokenizer.save_pretrained("squeezebert_model")
