...
def main():
    ...
    tokenizer = AlbertTokenizer.from_pretrained('/project/verma/TextAttack_Parisa/albert/albert_model')
    ...
    model = model = AlbertForSequenceClassification.from_pretrained("/project/verma/TextAttack_Parisa/albert/albert_model", num_labels=2)
