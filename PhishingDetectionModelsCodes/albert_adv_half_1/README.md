...
textattack attack --model-from-huggingface /project/verma/TextAttack_Parisa/albert/albert_model --dataset-from-file /project/verma/TextAttack_Parisa/albert/textAttack_dataset.py --recipe deepwordbug --num-examples 518
